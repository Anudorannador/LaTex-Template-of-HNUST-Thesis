...
% 章节设置
	% 章节页眉页脚设置
\newcommand{\wuhao}{\fontsize{10pt}{10pt}\selectfont} % 五号字体
...
\titlecontents{chapter}[0em]{\addvspace{18pt}\sihao}{\bfseries 第 \CJKnumber\thecontentslabel 章\quad}{}{\wuhao\titlerule*[5pt]{$\cdot$}\contentspage} % 目录章样式，四号加粗宋体 titlerule*[Xpt]调整点的密集度，X越小密度越高
\titlecontents{section}[2em]{\addvspace{14pt}\xiaosi}{\thecontentslabel\quad}{}{\wuhao\titlerule*[5pt]{$\cdot$}\contentspage}% 目录节样式
\titlecontents{subsection}[4em]{\addvspace{8pt}\xiaosi}{\thecontentslabel\quad}{}{\wuhao\titlerule*[5pt]{$\cdot$}\contentspage}
...
% 参考文献
\newpage
\fancypagestyle{plain}{% 因为参考文献第一个页要用到 plain 的page style.
	\fancyhf{}
