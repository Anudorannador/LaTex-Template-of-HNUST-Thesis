...
\usepackage{enumitem}
	...
	% itemindent=48 首行空48pt，一个字12pt，因为跟正文左对齐，所以首行要缩进4个字
	% itemsep=-3pt 每两个item的上下间距减小，更紧凑
\setenumerate{label=(\arabic*), leftmargin=0pt, itemindent=48pt, itemsep=-3pt} % 带序列号
\setlist{leftmargin=0pt, itemindent=48pt, itemsep=-3pt} % 不带序列号
